...
Plug 'Valloric/YouCompleteMe', {'do': 'EXTRA_CMAKE_ARGS=-DEXTERNAL_LIBCLANG_PATH=/usr/lib/llvm/5/lib64/libclang.so ./install.py --clang-completer --racer-completer --system-boost', 'for': ['c', 'cpp', 'python', 'objc', 'objcpp', 'rust']}
